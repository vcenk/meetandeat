...
export const menuSections: MenuSection[] = [
  {
    ...
    items: [
      ...
      { name: "Iskender Kebab", description: "Marinated beef slices over pita bread, topped with tomato sauce and melted butter, served with yogurt.", price: 24, featured: true, image: "/images/menu/Kebabs/Iskender Kebab.png" },
      ...
      { name: "Lamb Shish", description: "Grilled marinated lamb skewers, served with rice, onion, and sour red cabbage salad, and flatbread.", price: 29, image: "/images/menu/Kebabs/Lamb Shish.png" },
      ...
      { name: "Chicken Wings", description: "Grilled marinated chicken wings, served with rice, onion, and sour red cabbage salad, and flatbread.", price: 19, image: "/images/menu/Kebabs/17 Wings.jpg" },
  ...
  },
  {
    ...
    items: [
      { name: "Fettucini Alfredo", description: "Creamy fettuccine alfredo with tender chicken slices and sauteed mushrooms.", price: 18, image: "/images/menu/Pasta/14 Fettucini.jpg" },
      { name: "Stuffed Eggplant", description: "Eggplant stuffed with a savory mix of tomatoes, peppers, and onions, accompanied by rice and flatbread.", price: 18, image: "/images/menu/Traditional Dishes/35 Karni Yarik.jpg" },
      { name: "Lamb Shank", description: "Slow-cooked lamb shank, seasoned with spices and topped with mozzarella, served with rice and flatbread.", price: 25, featured: true, image: "/images/menu/Traditional Dishes/36 Lamb Shank.jpg" },
      { name: "Spaghetti Bolognese", description: "Classic spaghetti paired with a hearty tomato-based Bolognese sauce made from ground beef.", price: 18, image: "/images/menu/Pasta/13 Spagetti.jpg" },
      ...
      { name: "Beef Casserole", description: "Slow-cooked traditional Turkish casserole with beef, tomatoes, peppers, onions, and spices. Served with rice and flatbread.", price: 28, image: "/images/menu/Traditional Dishes/6 Beef Casserole.png" },
      ...
      { name: "Beef Saute", description: "Beef, peppers, onions, and tomatoes sauteed in a 'pot' pan with spices. Served with rice and flatbread.", price: 28, image: "/images/menu/Traditional Dishes/4 Beef Saute.png" },
      { name: "Chicken Shish Wrap", description: "Grilled marinated chicken skewers, lettuce, onion, and tomato wrapped in flatbread.", price: 14, image: "/images/menu/Wraps/31 Chicken Wrap.jpg" },
      { name: "Beef Doner Wrap", description: "Thinly sliced marinated beef doner, lettuce, onion, and tomato wrapped in flatbread.", price: 15, image: "/images/menu/Wraps/32 Doner Wrap.jpg" },
      { name: "Adana Wrap", description: "Minced beef kebab, lettuce, onion, and tomato wrapped in flatbread.", price: 16, image: "/images/menu/Wraps/33 Adana Wrap.jpg" },
    ],
  },
  {
    slug: "pides",
    ...
    items: [
      { name: "Lahmacun (XL 18\")", description: "Thin flatbread topped with a savory mixture of minced meat, vegetables, and spices, served with fresh parsley, sumac, onions, and lemon.", price: 20, featured: true, image: "/images/menu/Pides/Lahmacun (XL-18).png" },
      { name: "Kiymali Pide", description: "Turkish flatbread topped with minced meat, onions, and aromatic spices, baked to perfection.", price: 20, image: "/images/menu/Pides/19 Ground Beef Pide.jpg" },
      { name: "Mevlana Pide", description: "Flatbread topped with spiced minced beef, a mix of vegetables, and feta cheese.", price: 21, image: "/images/menu/Pides/20 Mevlana.jpg" },
      { name: "Kusbasili Pide", description: "Flatbread topped with tender diced beef and aromatic spices, baked to perfection.", price: 23, image: "/images/menu/Pides/21 Kusbasili pide.jpg" },
      ...
      { name: "Soujouk and Mozzarella Pide", description: "Flatbread topped with savory sausage and melted mozzarella cheese, baked until golden.", price: 21, image: "/images/menu/Pides/Soujouk and Mozarella Pide.png" },
  ...
  },
  {
    ...
    items: [
      { name: "Lentil Soup", description: "Hearty red lentil soup with onions, carrots, and spices, served with lemon and bread.", price: 8, altPrice: { label: "Half bowl", price: 5 }, image: "/images/menu/Soups/Lentil Soup.jpg" },
      ...
      { name: "Cacik", description: "Yogurt with cucumber and garlic, seasoned with olive oil and mint.", price: 7, dietary: ["vegetarian", "contains-dairy"], image: "/images/menu/Appetizer/Cacik.png" },
      { name: "Ezme", description: "Finely chopped tomato, cucumber, and pepper with olive oil, pomegranate molasses, and red pepper flakes.", price: 7, dietary: ["vegan"], image: "/images/menu/Appetizer/Ezme.png" },
      { name: "Eggplant Puree", description: "Roasted eggplant blended with olive oil, garlic, and lemon for a smoky flavor.", price: 7, dietary: ["vegan"], image: "/images/menu/Appetizer/Eggplant Puree.png" },
      { name: "Hummus", description: "Chickpeas blended with tahini, garlic, lemon juice, and olive oil for a smooth dip.", price: 7, dietary: ["vegan"], image: "/images/menu/Appetizer/Hummus.png" },
      { name: "Mix Appetizer", description: "A rich selection of five separate plates featuring ezme, eggplant puree, cacik, and hummus.", price: 19, dietary: ["vegetarian"], featured: true, image: "/images/menu/Appetizer/Mix Mezze.jpg" },
      { name: "Kofte for Kids", description: "Crafted with a blend of homemade meat, onions, and special spices. Served with French fries. Substitution: 1 Adana skewer, 1 lamb skewer, 1 chicken skewer, or 1 wing skewer.", price: 12, image: "/images/menu/Appetizer/Kofte for Kids.jpg" },
