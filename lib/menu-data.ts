...
export const menuSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Chicken Saute", description: "Chicken, peppers, onions, and tomatoes sauteed in a 'pot' pan with spices. Served with rice and flatbread.", price: 25, image: "/images/menu/Traditional Dishes/Chicken Sote.png" },
      { name: "Beef Saute", description: "Beef, peppers, onions, and tomatoes sauteed in a 'pot' pan with spices. Served with rice and flatbread.", price: 28, image: "/images/menu/Traditional Dishes/Beef Sote.png" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Mevlana Pide", description: "Flatbread topped with spiced minced beef, a mix of vegetables, and feta cheese.", price: 21, image: "/images/menu/Pides/Mevlana.jpg" },
      ...
      { name: "Chicken Pide", description: "Flatbread topped with marinated chicken and fresh vegetables, baked to a crisp.", price: 17, image: "/images/menu/Pides/Chicken Pide.jpg" },
      { name: "Four-Section Pide", description: "A flatbread baked to perfection, divided into four delicious sections: chicken, sausage and mozzarella, spinach and feta, and ground meat.", price: 21, image: "/images/menu/Pides/Mix Pide.jpg" },
      { name: "Mix Meat Pide", description: "A rich and satisfying feast featuring a combination of minced meat, diced beef, and soujouk with mozzarella on pide.", price: 22, image: "/images/menu/Pides/Mix Meat Pide 2.png" },
      ...
      { name: "Mushroom Pide", description: "Flatbread topped with mushrooms, peppers, cheese, and butter, baked to perfection.", price: 17, dietary: ["vegetarian"], image: "/images/menu/Pides/Mantarli Pide.jpg" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Tuna on Seasonal Salad", description: "Tender tuna on a fresh seasonal salad with a light, refreshing dressing.", price: 12, image: "/images/menu/Salads/Tuna Salad.jpg" },
    ],
  },
  {
    ...
    items: [
      { name: "Kunefe", description: "Shredded phyllo pastry layered with sweet cheese, baked until golden, soaked in syrup.", price: 10, dietary: ["vegetarian", "contains-dairy"], featured: true, image: "/images/menu/Deserts/Kunefe.jpg" },
