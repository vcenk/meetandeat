...
export const menuSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      { name: "Lahmacun (XL 18\")", description: "Thin flatbread topped with a savory mixture of minced meat, vegetables, and spices, served with fresh parsley, sumac, onions, and lemon.", price: 19, featured: true, image: "/images/menu/Pides/Lahmacun (XL-18).png" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Cacik", description: "Yogurt with cucumber and garlic, seasoned with olive oil and mint.", price: 6, dietary: ["vegetarian", "contains-dairy"], image: "/images/menu/Appetizer/Cacik.png" },
      { name: "Ezme", description: "Finely chopped tomato, cucumber, and pepper with olive oil, pomegranate molasses, and red pepper flakes.", price: 6, dietary: ["vegan"], image: "/images/menu/Appetizer/Ezme.png" },
      { name: "Eggplant Puree", description: "Roasted eggplant blended with olive oil, garlic, and lemon for a smoky flavor.", price: 6, dietary: ["vegan"], image: "/images/menu/Appetizer/Eggplant Puree.png" },
      { name: "Hummus", description: "Chickpeas blended with tahini, garlic, lemon juice, and olive oil for a smooth dip.", price: 6, dietary: ["vegan"], image: "/images/menu/Appetizer/Hummus.png" },
      ...
      { name: "Kofte for Kids", description: "Crafted with a blend of homemade meat, onions, and special spices. Served with French fries. Substitution: 1 Adana skewer, 1 lamb skewer, 1 chicken skewer, or 1 wing skewer.", price: 11, image: "/images/menu/Appetizer/Kofte for Kids.jpg" },
